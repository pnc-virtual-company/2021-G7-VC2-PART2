  ...
  <nav>
    <v-navigation-drawer v-model="sidebar" app absolute left temporary>
      <v-list>
        ...
        >
          <div class="navRes">
            <v-btn class="mb-3" text
              active-class="grey-5 white--text"
              
              v-if="appTitle.role === 'admin'"
            >
            ...
            <v-btn active-class="grey-5 white--text" class="mb-3" text>
    ...
    <v-toolbar class="orange lighten-1">
      ...
      <v-toolbar-title class="d-flex">
        ...
        <v-toolbar-title class="text-uppercase mt-4">
          {{ appTitle.userName }}</v-toolbar-title
        >
      </v-toolbar-title>
      <v-spacer></v-spacer>
